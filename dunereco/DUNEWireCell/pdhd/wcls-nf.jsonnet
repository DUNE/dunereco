...
// noise filtering to existing RawDigits.  The FHiCL is expected to
// provide the following parameters as attributes in the "params" structure.
...
local data_params = import 'pdhd/params.jsonnet';
local simu_params = import 'pdhd/simparams.jsonnet';
...
local wcls_output = {
  ...
  nf_digits: g.pnode({
    ...
    data: {
      ...
      // nticks: params.daq.nticks,
      chanmaskmaps: ['bad'],
      nticks: 0, // If nonzero, force number of ticks in output waveforms.
