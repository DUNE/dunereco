...
function(params, anode, field, n, rms_cuts=[])
  {
    ...
    channel_info: [
      ...
      // wish to change them.
      {
        channels: std.range(n * 1600, (n + 1) * 1600 - 1),
	...
	channels: std.range(n * 1600, n * 1600 + 384- 1),
	freqmasks: [
	...
	channels: std.range(n * 1600 + 384, n * 1600 + 1024- 1),
        freqmasks: [
          { value: 1.0, lobin: 0, hibin: $.nsamples - 1 },
          { value: 0.0, lobin: 169, hibin: 173 },
          { value: 0.0, lobin: 513, hibin: 516 },
	...
	channels: std.range(n * 1600 + 1600, n * 1600 + 1600- 1),
