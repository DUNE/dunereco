...
local spfilt = import 'pgrapher/experiment/dune10kt-1x2x6/sp-filters.jsonnet';
...
function(params, tools, override = {}) {
  ...
  make_sigproc(anode, name=null):: g.pnode({
    ...
    data: {
      ...
      /**
       *  Custom settings to lower ROI threshold for
       *  blip reconstruction (Oct 2024). Settings inspired 
       *  by those used for MicroBooNE MeV-scale analyses.
       */
      ...
      r_fake_signal_low_th: 1,  // standard 375
      r_fake_signal_high_th: 1,  // standard 750
      r_fake_signal_low_th_ind_factor: 375,  // default 1
      r_fake_signal_high_th_ind_factor: 750,  // default 1      
