...
local params_maker = import 'dune10kt-1x2x6/simparams.jsonnet';
local params = params_maker({});

local tools = tools_maker(params);

local sim_maker = import 'dune10kt-1x2x6/sim.jsonnet';
...
local multimagnify = import 'dune10kt-1x2x6/multimagnify.jsonnet';
...
local sp_maker = import 'dune10kt-1x2x6/sp.jsonnet';
