...
//
local track_length = 2.0;
local track_head = [-3.0, 3.0, 0.2];
# V - U for APA 0
// local track_direction = [0.580387,0.210183,0.563658]; # V 45, U 60 for APA0; V 60, U 45 for APA1
...
# jinst-resub
// local track_direction = [0.914219,0.168842,0.180324]; # 75, 87
local track_direction = [0.942868,0.028341,0.081213]; # 85, 87
...
local wcls_input = {
    ...
    // depos: wcls.input.depos(name=""),  // default art_tag="blopper"
};
...
local base = import 'protodunevd/chndb-base.jsonnet';
local chndb = [{
...
//local chndb_maker = import 'protodunevd/chndb.jsonnet';
...
//     type: "wire-cell",
//     data: {
//         plugins: ["WireCellPgraph", "WireCellGen","WireCellSio","WireCellRoot","WireCellLarsoft","WireCellHio","WireCellTbb",'WireCellImg',"WireCellPytorch"],
//         apps: ["Pgrapher"]
//     }   
// };
