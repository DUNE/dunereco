...
local params_maker = import 'dune10kt-hd/simparams.jsonnet';
local fcl_params = {
...
local sim_maker = import 'dune10kt-hd/sim.jsonnet';
...
local nf_maker = import 'dune10kt-hd/nf.jsonnet';
...
local sp_maker = import 'dune10kt-hd/sp.jsonnet';
...
local magnify = import 'dune-vd/magnify-sinks.jsonnet';
