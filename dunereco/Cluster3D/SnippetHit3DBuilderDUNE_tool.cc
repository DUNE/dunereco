/**
 *  @file   SnippetHit3DBuilderDUNE_tool.cc
 *
 ...
 */
  ...
  /**
 *  @brief  SnippetHit3DBuilderDUNE class definiton
 */
  class SnippetHit3DBuilderDUNE : public IHit3DBuilder {
  public:
    /**
     *  @brief  Constructor
     *
     *  @param  pset
     */
    explicit SnippetHit3DBuilderDUNE(fhicl::ParameterSet const& pset);
  ...
  SnippetHit3DBuilderDUNE::SnippetHit3DBuilderDUNE(fhicl::ParameterSet const& pset)
  ...
  void SnippetHit3DBuilderDUNE::produces(art::ProducesCollector& collector)
  {
  ...
  void SnippetHit3DBuilderDUNE::configure(fhicl::ParameterSet const& pset)
  {
    ...
    if (m_outputHistograms) {
      ...
      m_tupleTree = tfs->make<TTree>("Hit3DBuilderTree", "Tree by SnippetHit3DBuilderDUNE");
  ...
  void SnippetHit3DBuilderDUNE::clear()
  {
  ...
  void SnippetHit3DBuilderDUNE::Hit3DBuilder(art::Event& evt,
                                         ...
                                         RecobHitToPtrMap& clusterHitToArtPtrMap)
  {
    ...
    mf::LogDebug("SnippetHit3D") << "SnippetHit3DBuilderDUNE entered" << std::endl;
    ...
    mf::LogDebug("SnippetHit3D") << "SnippetHit3DBuilderDUNE building space points";
    ...
    mf::LogDebug("SnippetHit3D") << "SnippetHit3DBuilderDUNE exited";

    return;
  }

  void SnippetHit3DBuilderDUNE::BuildHit3D(reco::HitPairList& hitPairList) const
  {
    /**
  ...
  size_t SnippetHit3DBuilderDUNE::BuildHitPairMap(PlaneToSnippetHitMap& planeToSnippetHitMap,
                                              reco::HitPairList& hitPairList) const
  {
    /**
  ...
  size_t SnippetHit3DBuilderDUNE::BuildHitPairMapByTPC(
  ...
  int SnippetHit3DBuilderDUNE::findGoodHitPairs(SnippetHitMap::iterator& firstSnippetItr,
  ...
  void SnippetHit3DBuilderDUNE::findGoodTriplets(HitMatchTripletVecMap& pair12Map,
                                             HitMatchTripletVecMap& pair13Map,
                                             MatchedHitMap& matchedHitMap,
                                             reco::HitPairList& hitPairList,
                                             bool tagged) const
  ...
  int SnippetHit3DBuilderDUNE::saveOrphanPairs(HitMatchTripletVecMap& pairMap,
                                           MatchedHitMap& matchedHitMap,
                                           reco::HitPairList& hitPairList) const
  {
  ...
  int SnippetHit3DBuilderDUNE::saveBadChannelPairs(HitMatchTripletVecMap& pairMap,
                                               MatchedHitMap& matchedHitMap,
                                               reco::HitPairList& hitPairList) const
  {
    int curTripletCount = hitPairList.size();
  ...
  bool SnippetHit3DBuilderDUNE::makeHitPair(reco::ClusterHit3D& hitPair,
                                        const reco::ClusterHit2D* hit1,
                                        const reco::ClusterHit2D* hit2,
  ...
  bool SnippetHit3DBuilderDUNE::makeHitTriplet(reco::ClusterHit3D& hitTriplet,
                                           MatchedHitMap& matchedHitMap,
                                           const reco::ClusterHit3D& pair,
  ...
  bool SnippetHit3DBuilderDUNE::WireIDsIntersect(const geo::WireID& wireID0,
  ...
  float SnippetHit3DBuilderDUNE::closestApproach(const Eigen::Vector3f& P0,
  ...
  float SnippetHit3DBuilderDUNE::chargeIntegral(float peakMean,
                                            float peakAmp,
                                            float peakSigma,
                                            float areaNorm,
                                            int low,
  ...
  const reco::ClusterHit2D* SnippetHit3DBuilderDUNE::FindBestMatchingHit(
  ...
  int SnippetHit3DBuilderDUNE::FindNumberInRange(const Hit2DSet& hit2DSet,
                                             const reco::ClusterHit3D& pair,
                                             float range) const
  {
    static const float minCharge(0.);
  ...
  geo::WireID SnippetHit3DBuilderDUNE::NearestWireID(const Eigen::Vector3f& position,
  ...
  float SnippetHit3DBuilderDUNE::DistanceFromPointToHitWire(const Eigen::Vector3f& position,
                                                        const geo::WireID& wireIDIn) const
  {
  ...
  //------------------------------------------------------------------------------------------------------------------------------------------
  void SnippetHit3DBuilderDUNE::CollectArtHits(const art::Event& evt) const
  {
    /**
  ...
  void SnippetHit3DBuilderDUNE::CreateNewRecobHitCollection(art::Event& event,
                                                        reco::HitPairList& hitPairList,
  ...
  void SnippetHit3DBuilderDUNE::makeWireAssns(const art::Event& evt,
  ...
  void SnippetHit3DBuilderDUNE::makeRawDigitAssns(const art::Event& evt,
  ...
  DEFINE_ART_CLASS_TOOL(SnippetHit3DBuilderDUNE)
} // namespace lar_cluster3d
