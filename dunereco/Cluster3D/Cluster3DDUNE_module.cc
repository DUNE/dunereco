 ...
 */
  class Cluster3DDUNE : public art::EDProducer {
  public:
    explicit Cluster3DDUNE(fhicl::ParameterSet const& pset);
  ...
  private:
     ...
     *
     *  @param hitPairList           List of all 3D Hits in internal Cluster3DDUNE format
  ...
  DEFINE_ART_MODULE(Cluster3DDUNE)

} // namespace lar_Cluster3DDUNE
...
namespace lar_cluster3d {
  ...
  Cluster3DDUNE::Cluster3DDUNE(fhicl::ParameterSet const& pset)
    : EDProducer{pset}
  ...
  void Cluster3DDUNE::produce(art::Event& evt)
  {
  ...
  void Cluster3DDUNE::InitializeMonitoring()
  {
  ...
  void Cluster3DDUNE::PrepareEvent(const art::Event& evt)
  {
    m_run = evt.run();
    m_event = evt.id().event();
    m_hits = 0;
  ...
  void Cluster3DDUNE::findTrackSeeds(art::Event& evt,
                                 reco::ClusterParameters& cluster,
                                 IHit3DBuilder::RecobHitToPtrMap& hitToPtrMap,
                                 std::vector<recob::Seed>& seedVec,
                                 art::Assns<recob::Seed, recob::Hit>& seedHitAssns) const
  ...
  void Cluster3DDUNE::splitClustersWithHough(reco::ClusterParameters& clusterParameters,
                                         reco::ClusterParametersList& clusterParametersList) const
  {
  ...
  void Cluster3DDUNE::ProduceArtClusters(util::GeometryUtilities const& gser,
                                     ArtOutputHandler& output,
  ...
  size_t Cluster3DDUNE::countUltimateDaughters(reco::ClusterParameters& clusterParameters) const
  {
    size_t localCount(0);
  ...
  size_t Cluster3DDUNE::FindAndStoreDaughters(util::GeometryUtilities const& gser,
                                          ArtOutputHandler& output,
                                          reco::ClusterParameters& clusterParameters,
                                          size_t pfParticleParent,
                                          IdxToPCAMap& idxToPCAMap,
  ...
  size_t Cluster3DDUNE::ConvertToArtOutput(util::GeometryUtilities const& gser,
                                       ArtOutputHandler& output,
                                       reco::ClusterParameters& clusterParameters,
                                       size_t pfParticleParent,
                                       IHit3DBuilder::RecobHitToPtrMap& hitToPtrMap,
  ...
  void Cluster3DDUNE::MakeAndSaveSpacePoints(ArtOutputHandler& output,
                                         std::vector<recob::SpacePoint>& spacePointVec,
                                         art::Assns<recob::Hit, recob::SpacePoint>& spHitAssns,
                                         reco::HitPairListPtr& clusHitPairVector,
                                         IHit3DBuilder::RecobHitToPtrMap& hitToPtrMap,
  ...
  void Cluster3DDUNE::MakeAndSaveKinkPoints(ArtOutputHandler& output,
  ...
  void Cluster3DDUNE::MakeAndSaveVertexPoints(ArtOutputHandler& output,
  ...
  void Cluster3DDUNE::MakeAndSavePCAPoints(ArtOutputHandler& output,
