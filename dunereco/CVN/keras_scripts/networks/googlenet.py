...
def googlenet(input_shape=[500,500,3], classes=13, weights_path=None):
    ...
    loss3_classifier = Dense(classes,name='loss3/classifier',W_regularizer=l2(0.0002))(pool5_drop_7x7_s1)
