...
if args.output_model_file == '':
    args.output_model_file = str(args.input_model_file) + '.pb'
...
if args.graph_def:
    ...
    print('saved the graph definition in ascii format at: ', '.' / f)
...
print('saved the freezed graph (ready for inference) at: ', str(args.output_model_file))
