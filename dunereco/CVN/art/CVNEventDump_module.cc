...
//    if(truth.NeutrinoSet()){
    ...
    float nu_px = truthN.Nu().Px();
    float nu_py = truthN.Nu().Py();
    float nu_pz = truthN.Nu().Pz();
...
//    }
    ...
    TrainingData train(interaction, nuEnergy, nu_px, nu_py, nu_pz, lepEnergy, lepangle, recoNueEnergy,
