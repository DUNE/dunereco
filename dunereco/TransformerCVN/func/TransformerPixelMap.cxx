...
namespace cnn
{
  ...
  void TransformerPixelMap::Add(const int& wire, const int& tdc, const unsigned int& view, const double& pe, const unsigned int& tpc, int hit_prong_tag)
  {
  ...
  unsigned int  TransformerPixelMap::LocalToIndex(const unsigned int& wire,
  ...
  unsigned int  TransformerPixelMap::GlobalToIndexSingle(const int& wire,
                                              const int& tdc,
                                              const unsigned int& view)
  ...
  void  TransformerPixelMap::GetTPC(const int& wire,
                             const int& tdc,
                             const unsigned int& view,
  ...
  void TransformerPixelMap::Print()
  {
  ...
  TH2F* TransformerPixelMap::ToTH2() const
  {

    // Create a histogram, use twice as many tdcs to distinguish views
    TH2F* hist = new TH2F("TransformerPixelMap", ";Wire;Tdc", fNWire, 0, fNWire,
                                                      fNTdc*3, 0, fNTdc*3);
  ...
  TH2F* TransformerPixelMap::ToLabTH2() const
  {
  ...
  TH2F* TransformerPixelMap::SingleViewToTH2(const unsigned int& view) const
  {
  ...
  std::ostream& operator<<(std::ostream& os, const TransformerPixelMap& m)
  {
    os << "TransformerPixelMap with " << m.NPixel() << " pixels, "
                           << m.NWire() << " wires"
                << " by "  << m.NTdc()  << " tdcs" ;
    return os;
  }
